    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, choices=[('fridge', 'Fridge'), ('dishwasher', 'Dishwasher'), ('tv', 'TV'), ('washer', 'Washing machine'), ('furniture', 'Furniture'), ('stove', 'Stove'), ('oven', 'Oven'), ('balcony', 'Balcony'), ('terrace', 'Terrace'), ('elevator', 'elevator'), ('ac', 'Air conditioning')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Flat',
            fields=[
                ...
                ('rooms', models.IntegerField(choices=[('one', '1'), ('two', '2'), ('three', '3'), ('four', '4'), ('five', '5'), ('six', '6'), ('seven', '7'), ('eight', '8'), ('nine', '9'), ('ten', '10'), ('more', 'more than 10')])),
