    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flat', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rooms', models.CharField(choices=[('one', '1'), ('two', '2'), ('three', '3'), ('four', '4'), ('five', '5'), ('six', '6'), ('seven', '7'), ('eight', '8'), ('nine', '9'), ('ten', '10'), ('more', 'more than 10')], max_length=30)),
                ...
                ('flat', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='detail', to='flat.flat')),
            ],
        ),
        migrations.AddConstraint(
            model_name='flatdetail',
            constraint=models.CheckConstraint(check=models.Q(('area__gte', 0.0)), name='flatDetail_area_range'),
        ),
    ]
